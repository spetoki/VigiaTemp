...
import { ThermometerSnowflake, Home, Settings, BrainCircuit, Menu, LineChart, SlidersHorizontal, Bell, Wrench, ClipboardList, Activity, Info, FileCode2, Users, LogOut, Building2, ShieldCheck, DollarSign, AlertTriangle, Rss } from 'lucide-react';
...
export default function AppHeader() {
  ...
  const appInfoNavItems = [
      { href: '/updates', labelKey: 'nav.updates', icon: Rss, defaultLabel: 'Atualizações' },
